...
public class GenerateJobIndividualPDF {

    WebDriver driver;

    public GenerateJobIndividualPDF(WebDriver driver) {
    ...
    WebElement SelectJobOpeningFromPDF;
    ...
    public void GetSelectJobOpeningFromPDF() {
        Select select = new Select(SelectJobOpeningFromPDF);
        select.selectByIndex(1);
    }
