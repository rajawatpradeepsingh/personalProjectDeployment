...
public class manageUserDefaultPDFIndividualReport {
    WebDriver driver;

    public manageUserDefaultPDFIndividualReport(WebDriver driver) {
        this.driver = driver;
    ...
    // @FindBy(xpath = "//select[@id='mod-status']")
    // WebElement ClickSingleUser;
    ...
    // public void GetClickSingleUser(){
    // Select select = new Select(ClickSingleUser);
